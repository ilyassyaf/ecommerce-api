...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Stewart97',
      password: 'P7a7tF6u4XulCl_',
      email: 'Humberto.Lakin12@hotmail.com',
      name: 'Gina Deckow',
      shippingAddress: [
        {
          _id: false,
      ...
      wishlist: [ {
        _id: false,
        productId: 'Programmable' 
      } ],
      userType: 663,
      mobileNo: '(232) 793-4260',
      resetPasswordLink: {},
      loginRetryLimit: 846,
      loginReactiveTime: '2023-05-29T23:01:12.421Z',
      id: '6368cbd49a8f987437bd3190'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'John.Windler84',
        'password':'UlafGeugEirasOj',
        'email':'Johan.Gerlach17@hotmail.com',
        'name':'Estelle Windler PhD',
        'shippingAddress':[{
          '_id':false,
          'pincode':'HDD',
          'address1':'wireless',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Johan.Gerlach17@hotmail.com', });
